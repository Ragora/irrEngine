#include <CWheeledVehicle.h>

CWheeledVehicle::CWheeledVehicle(IrrlichtDevice *device, irrBulletWorld *world, IMesh *mesh)
{
    Device = device;
    World = world;
...
CWheeledVehicle::~CWheeledVehicle(void)
{
    Node->remove();
}

void CWheeledVehicle::think()
{

}

IAnimatedMeshSceneNode *CWheeledVehicle::getNode()
{
    return Node;
}

void CWheeledVehicle::addWheel(vector3df offset)
{
